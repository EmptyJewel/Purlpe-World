...
win = font2.render('SKIBIDI SKIBIDI!', True, (0, 0, 0))
lose = font2.render('SKIBIDI SKIBIDI!', True, (0 ,0 ,0 ))
...
for i in range(1,6):
    monster = Enemy(img_enemy, 700,randint(100, 300), 80, 50, randint(1, 3))
    monsters.add(monster)

for i in range(1,2):
    asteroid = Asteroid(img_asteroid, randint(80,win_width - 80), -40, 70, 80, randint(3, 4))
...
while run:
    ...
    if not finish:
        ...
        for collide in collides:
            score += 1
            monster = Enemy(img_enemy,700,randint(100, 300), 100, 100, randint(1, 3))
            monsters.add(monster)
